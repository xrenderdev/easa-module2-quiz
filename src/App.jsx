...
const conceptBank = [
  ...
  },
  {
    ...
    concept: "Voltage",
    answer: "Volt",
    hint: "Voltage is electrical potential difference. Unit is V.",
    formula: "V = IR",
    traps: ["Ampere", "Ohm", "Watt", "Coulomb"],
    stems: ["Unit of potential difference", "Voltage is measured in", "Electrical pressure unit", "Potential difference unit"],
  },
  {
    chapter: "Electricity & Magnetism",
    concept: "Current",
    answer: "Ampere",
    hint: "Current is flow of electric charge.",
    formula: "I = Q/t",
    traps: ["Volt", "Ohm", "Watt", "Tesla"],
    stems: ["Unit of electric current", "Current is measured in", "Flow of charge unit", "Amp is unit of"],
  },
  {
    chapter: "Electricity & Magnetism",
    concept: "Resistance",
    answer: "Ohm",
    hint: "Resistance opposes current. Unit is ohm.",
    formula: "R = V/I",
    traps: ["Volt", "Ampere", "Watt", "Henry"],
    stems: ["Unit of electrical resistance", "Resistance is measured in", "Opposition to current unit", "Ohm is unit of"],
  },
  {
    chapter: "Electricity & Magnetism",
    concept: "Ohm's Law",
    answer: "V = IR",
    hint: "Ohm's law links voltage, current, and resistance.",
    formula: "V = IR",
    traps: ["P = W/t", "F = ma", "p = mv", "ρ = m/V"],
    stems: ["Ohm's law formula", "Voltage equals current times resistance", "Electrical formula for V, I and R", "Formula used for current through resistance"],
  },
  {
    chapter: "Electricity & Magnetism",
    concept: "Motor",
    answer: "Motor",
    hint: "Motor: electrical into mechanical movement.",
    formula: "Electrical → mechanical",
    traps: ["Generator", "Compressor", "Turbine", "Battery"],
    stems: ["Device converting electrical energy to mechanical energy", "Electrical energy to rotation", "An electric device that produces motion", "Converts electrical input into mechanical output"],
  },
  {
    chapter: "Electricity & Magnetism",
    concept: "Generator",
    answer: "Generator",
    hint: "Generator: mechanical movement into electrical energy.",
    formula: "Mechanical → electrical",
    traps: ["Motor", "Pump", "Battery", "Compressor"],
    stems: ["Device converting mechanical energy to electrical energy", "Rotation to electricity", "Produces electrical energy from motion", "Converts mechanical input into electrical output"],
  },
  {
